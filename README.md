...
- **Test Explorer Integration:** Run and debug features with line-by-line execution tracking and pristine Markdown-formatted error traces, ordered strictly chronologically as written in your code. The authoritative `BehaveExecutionPlan` guarantees unified environment resolution consistency across Run, Debug, and Tasks.
