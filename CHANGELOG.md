...
- **Debug Mode: Test Results Pollution**: Fixed a critical UX regression where triggering `🐞 Debug` from the Test Explorer was incorrectly recorded as a completed test run inside the **Test Results** panel.
