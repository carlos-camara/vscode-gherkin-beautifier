...
const CONFIG = {
    ...
    forbiddenPatterns: [
        ...
        { pattern: /^extension\/\.github\//, description: 'GitHub workflow configuration (.github/)' },
        { pattern: /^extension\/\.vscode\//, description: 'VS Code workspace configuration (.vscode/)' },
        { pattern: /^extension\/\.vscode-test\//, description: 'VS Code test runner cache (.vscode-test/)' },
        { pattern: /^extension\/coverage\//, description: 'Test coverage output (coverage/)' },
        { pattern: /^extension\/\.nyc_output\//, description: 'NYC coverage cache (.nyc_output/)' },
        { pattern: /^extension\/test-results\//, description: 'Test results folder (test-results/)' },
        { pattern: /^extension\/\.gemini\//, description: 'Private workspace configuration folder (.gemini/)' },
        { pattern: /^extension\/\.agents\//, description: 'Private workspace configuration folder (.agents/)' },
        { pattern: /^extension\/\.agent\//, description: 'Private workspace configuration folder (.agent/)' },
        { pattern: /^extension\/skills\//, description: 'Private workspace skills folder (skills/)' },
        { pattern: /^extension\/(v?env|\.venv)\//, description: 'Python virtual environment folder' },
        { pattern: /^extension\/(tmp|\.tmp|temp)\//, description: 'Temporary directory' },
        { pattern: /\.(gif|mp4|webm|webp)$/i, description: 'Heavy media asset' },
        { pattern: /(SKILL\.md|skills\.json|AGENTS\.md)$/i, description: 'Private workspace metadata file' },
        { pattern: /vsix-validation-report\.md$/i, description: 'Generated validation report file' },
