...
const CONFIG = {
    ...
    forbiddenPatterns: [
        ...
        { pattern: /^extension\/\.gemini\//, description: 'Private Gemini agent configuration (.gemini/)' },
        { pattern: /^extension\/\.agents\//, description: 'Private agent skills folder (.agents/)' },
        { pattern: /^extension\/\.agent\//, description: 'Private agent skills folder (.agent/)' },
        { pattern: /^extension\/skills\//, description: 'Private skills folder (skills/)' },
        ...
        { pattern: /(SKILL\.md|skills\.json|AGENTS\.md)$/i, description: 'Private agent skill manifest' },
